...
base_model = AutoModelForCausalLM.from_pretrained("data/ap-gpt-j-6b-dpo-qlora")
peft_config = PeftConfig.from_pretrained("data/ap-gpt-j-6b-dpo-qlora")
lora_model = PeftModel.from_pretrained(base_model, "data/ap-gpt-j-6b-dpo-qlora", revision=peft_config.revision)
base_model = lora_model

tokenizer = AutoTokenizer.from_pretrained("data/ap-gpt-j-6b-dpo-qlora")
